...
export default {
  ...
  methods: {
    ...mapActions(['findUser','findTeams','createTeam','removeTeam','updateNameTeam','findAllStudents','findChild','createRequest','deleteRequest','updateChildClass','removeStudent','createNofication']),
